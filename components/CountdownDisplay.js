...
// import { TimeLeft } from '../types.js'; // TimeLeft interface not used at runtime

// interface CountdownDisplayProps removed
// interface TimeUnitProps removed

const TimeUnit = ({ value, label }) => { // React.FC and props type removed
...
const CountdownDisplay = ({ timeLeft }) => { // React.FC and props type removed
  return (
